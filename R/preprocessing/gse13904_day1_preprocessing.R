...
# Per-timepoint slice of GSE13904 (config/GSE13904_day1_config.yml) --
# filters to timepoint == "day1" from the SAME raw parquet trio
...
# `symbol` column rather than control_type / gene_symbol -- GSE13904 has no
# base (non-timepoint) preprocessing script to mirror directly, see
# config/GSE13904_config.yml's TODO).
