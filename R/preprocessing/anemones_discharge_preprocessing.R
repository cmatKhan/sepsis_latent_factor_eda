...
# Per-timepoint slice of ANEMONES (config/ANEMONES_discharge_config.yml) --
# filters to timepoint == "Day: Discharge" from the SAME raw parquet trio
